...
# Como se puede ver en la imágen adjuntada en el repositorio, la versión original de esta tarea era resolver cualquier ecuación de nuestro agrado utilizando el PSO
# Basandonos en esa descripción inicial, realizamos este codigo antes de que usted modificara la tarea para usar Algoritmos Genéticos, y no nos dimos cuenta hasta el dia que usted lo mencionó en clase
# Le preguntamos al respecto y nos dio el visto bueno a presentar este codigo usando el PSO en lugar de la versión nueva utilizando algoritmos genéticos
